...
def json_to_csv(rllib_json, csv_path):
    ...
    beh_df, eps, steps = load_json_to_df_max(beh_reader, 10000)
...
if __name__ == '__main__':
    ...
    CSV_PATH =  '/opt/ml/code/episodes/120820251600/011125_generated_rllib_ppo_rllib_seed_0000_1000eps_300steps_exp_0.csv'
