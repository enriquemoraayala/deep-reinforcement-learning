...
def json_to_csv(rllib_json, csv_path):
    ...
    beh_df, eps, steps = load_json_to_df_max(beh_reader, 1)
...
if __name__ == '__main__':
    ...
    BEH_EPISODES_JSON_VAL = '/opt/ml/code/episodes/120820251600/080226_generated_rllib_ppo_rllib_seed_11111_1eps_300steps_exp_0'
    ...
    CSV_PATH =  '/opt/ml/code/episodes/120820251600/080226_generated_rllib_ppo_rllib_seed_11111_1eps_300steps_exp_0.csv'
    json_to_csv(JSON_TO_CONVERT, CSV_PATH)
