...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--solve-streak", type=int, default=3)
    parser.add_argument("--checkpoint-every", type=int, default=10)
    parser.add_argument("--checkpoint-dir", type=str, default="./checkpoints_lunarlander_ppo")
    parser.add_argument("--results-csv", type=str, default="./lunarlander_ppo_results.csv")
...
def main() -> None:
    ...
    with results_csv.open("w", newline="", encoding="utf-8") as f_csv:
